...
export const createAnimalController: RequestHandler = catchAsyncError(
  async (req, res) => {
    const data = req.body;
...
export const getAnimalController: RequestHandler = catchAsyncError(
  async (req, res) => {
    const queryParams = req.query;

    const result = await getAnimalService(
